...
#"/Users/nataliamora/Library/CloudStorage/OneDrive-Personal/Documents/CU Boulder/Fall 2023/Neural Networks/Course Buddy Project/Rate My Professor/RateMyProfessorAPI/ratemyprofessor"
...
class School:
    ...
    def __init__(self, school_id: int):
        ...
        self._get_rating_info(school_id)
    ...
    def _get_rating_info(self, school_id: int):
        headers["Referer"] = "https://www.ratemyprofessors.com/ShowRatings.jsp?tid=%s" % school_id
        school_query["variables"]["id"] = base64.b64encode(("Teacher-%s" % school_id)
        ...
        self.departments = []
        for d in dept_data:
            self.departments.append(Department(school=self, dept_id=dept_data["id"],
                                   name=dept_data["name"]))
    ...
    def get_ratings(self):
            ...
            for rating_data in ratings_data:
                ...
                total_rating = np.mean(rating["facilitiesRating"], rating["foodRating"],
                ...
                ratings.append(Rating(rating=total_rating, comment=rating["comment"], date=date,
...
class Department:
    ...
    def __init__(self, school: School, dept_id: int, name: str):
        """
...
@total_ordering
class Rating:
    """Represents a university rating."""

    def __init__(self,  rating: int, comment: str, date: datetime,
